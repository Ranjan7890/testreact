        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form >
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
               ...
               <p>
                <Link to="/sign-in " className='text-blue-600 hover:text-blue-800 transistion duration-200 ease-in-out '>Sign in instead</Link>
                
               </p>
            </div>
            <button className="w-full bg-blue-600 px-7 py-3 rounded mt-6 text-white font-medium uppercase shadow-md hover:bg-blue-700 transistion duration-200 ease-in-out hover:shadow-lg "type="submit">Send reset Password</button>
