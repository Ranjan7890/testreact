    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form >
          <input type="text" id="name" value ={name}  onChange={onChange} placeholder="Full Name" className='w-full px-4 py-2 bg-white text-xl text-gray-700 border-gray-300 rounded transition ease-in-out mb-6' />
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
               <p >Have an account?
               <Link to="/sign-in" className='text-red-600 hover:text-red-800 transistion duration-200 ease-in-out ml-1'>Sign In</Link>
               </p>
               <p>
            ...
            <button className="w-full bg-blue-600 px-7 py-3 rounded mt-6 text-white font-medium uppercase shadow-md hover:bg-blue-700 transistion duration-200 ease-in-out hover:shadow-lg "type="submit">Sign Up</button>
